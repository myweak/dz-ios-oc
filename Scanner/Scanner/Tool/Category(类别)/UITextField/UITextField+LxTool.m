...
-(void)setPlaceholderLabelTextColor{
    @try{
        [self setValue:[UIColor c_GrayColor] forKeyPath:@"placeholderLabel.textColor"]; }@catch (NSException *exception){
            [self setValue:[UIColor c_GrayColor] forKeyPath:@"_placeholderLabel.textColor"];
