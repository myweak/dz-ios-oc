...
///duration 1700
static inline void showMessageWithDuration(NSString *msgString,CGFloat duration){
   [iToast showCenter_ToastWithText:msgString witduration:duration];
};
...
+ (instancetype)c_text_gary_Color;
...
// cell 左边主标题灰色
+ (instancetype)c_main_gary_Color;
