...
- (UIImageView *)centerImageView{
    if (!_centerImageView) {
        _centerImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, KSpace, self.width-KSpace, self.height-KSpace)];
        _centerImageView.image  = R_ImageName(@"play_viideo");
