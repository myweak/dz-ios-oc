...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([title isEqualToString:SName_title]) {
        ...
        [self.departmentTextField setPlaceholderLabelTextColor];
        ...
        [self.professionalTextField setPlaceholderLabelTextColor];
        ...
        [self.mAccountTextField setPlaceholderLabelTextColor];
        ...
        [self.sexTextField setPlaceholderLabelTextColor];
...
//        _departmentTextField.keyboardType =  UIKeyboardTypeNumberPad;
        ...
        _departmentTextField.textColor = [UIColor blackColor];
...
- (UITextField *)professionalTextField{
    if (!_professionalTextField) {
        ...
        _professionalTextField.textColor = [UIColor blackColor];
...
- (UITextField *)mAccountTextField{
    if (!_mAccountTextField) {
        ...
        _mAccountTextField.textColor = [UIColor blackColor];
