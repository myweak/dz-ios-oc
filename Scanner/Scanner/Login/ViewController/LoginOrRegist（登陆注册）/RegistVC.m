...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([title isEqualToString:SAccount_title]) {
        ...
        [self.accountTextField setPlaceholderLabelTextColor];
        ...
        [self.passWordTextField setPlaceholderLabelTextColor];

        [cell.contentView addSubview:self.passWordTextField];
    }else  if ([title isEqualToString:SNextPassWord_title]) {
        self.nextPassWordTextField.placeholder = title;
        [self.nextPassWordTextField setPlaceholderLabelTextColor];
        ...
        [self.phoneTextField setPlaceholderLabelTextColor];
        ...
        [self.codeTextField setPlaceholderLabelTextColor];
...
- (UITextField *)accountTextField{
    if (!_accountTextField) {
        ...
        [_accountTextField setPlaceholderLabelTextColor];
...
- (UITextField *)passWordTextField{
    if (!_passWordTextField) {
        ...
        [_passWordTextField setPlaceholderLabelTextColor];
...
- (UITextField *)nextPassWordTextField{
    if (!_nextPassWordTextField) {
        ...
        _nextPassWordTextField.textColor = [UIColor blackColor];
        ...
        [_nextPassWordTextField setPlaceholderLabelTextColor];
...
- (UITextField *)phoneTextField{
    if (!_phoneTextField) {
        ...
        [_phoneTextField setPlaceholderLabelTextColor];
...
- (UITextField *)codeTextField{
    if (!_codeTextField) {
        ...
        [_codeTextField setPlaceholderLabelTextColor];
