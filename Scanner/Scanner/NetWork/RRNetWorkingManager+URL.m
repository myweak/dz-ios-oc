...
- (void)getQiNiuImageUrl:(id)parameter result:(RrResponseResultBlockModel *)resultBlock{
    [self GET:KQiNiuImageUrl parameters:parameter result:resultBlock];
}
...
- (void)getWaitReadCountWithresult:(RrResponseResultBlockModel *)resultBlock{
    [self GET:@"/dz-service/worker/message/waitRead/count" parameters:nil result:resultBlock];
}
...
- (void)getOrderStatasNumber:(id)parameter result:(RrResponseResultBlockModel *)resultBlock{
    [self GET:@"/dz-service/worker/order/stat" parameters:parameter result:resultBlock];
}
...
- (void)putOrderRemindNotifi:(id)parameter result:(RrResponseResultBlockModel *)resultBlock{
    [self POST:@"/dz-service/worker/remind/ship" parameters:parameter result:resultBlock];
}
